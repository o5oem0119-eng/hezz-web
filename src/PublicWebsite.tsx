...
const campaign = {
  ...
  images: {
    product: '/assets/web-studio/hezz-calming-barrier-serum.png',
    portrait: '/assets/web-studio/hezz-neutral-face.jpg',
    application: '/assets/web-studio/hezz-dropper-application.jpg',
    room: '/assets/web-studio/hezz-product-introduction-room.jpg',
    hand: '/assets/web-studio/hezz-serum-hand-application.jpg',
    detail: '/assets/web-studio/hezz-skin-detail.jpg',
    comparisonSmoothed: '/assets/web-studio/hezz-comparison-smoothed.webp',
    comparisonNatural: '/assets/web-studio/hezz-comparison-natural.webp',
  },
};

const criteriaWorks = [
  { criterion: 'FRAMING', title: '조금은 어색한 구도', description: '여백과 비대칭이 남아 있는 전신 패션 프레임.', type: 'image', src: '/assets/web-studio/gallery/full-body-fashion.png', alt: '흰 스튜디오에서 촬영한 전신 패션 모델', left: '2%', top: '1%', height: 'clamp(390px, 52svh, 560px)' },
  ...
  { criterion: 'FRAMING', title: '조금은 어색한 구도', description: '창틀 안의 정지된 인물과 흐르는 도시를 함께 담습니다.', type: 'image', src: '/assets/web-studio/gallery/elderly-corner-motion.jpeg', alt: '차창 너머 도심 모서리에 서 있는 노인과 흐릿한 행인', left: '13%', top: '7%', height: 'clamp(270px, 36svh, 390px)' },
  { criterion: 'TEXTURE', title: '살아 있는 질감', description: '주근깨와 얇은 원단의 결을 지우지 않은 초상.', type: 'image', src: '/assets/web-studio/gallery/raw-texture-portrait.png', alt: '주근깨와 원단 질감이 보이는 패션 초상', left: '19%', top: '29%', height: 'clamp(290px, 38svh, 410px)' },
  { criterion: 'FRAMING', title: '조금은 어색한 구도', description: '멈춘 인물과 흐르는 도시가 한 프레임에 공존합니다.', type: 'image', src: '/assets/web-studio/gallery/rossio-motion-street.jpeg', alt: '움직이는 트램과 군중 사이 벤치에 앉은 노인', left: '25%', top: '0%', height: 'clamp(270px, 36svh, 390px)' },
  { criterion: 'EXPRESSION', title: '편안한 표정과 움직임', description: '정면을 응시하는 강한 태도와 느슨한 포즈.', type: 'image', src: '/assets/web-studio/gallery/editorial-suit-orange.png', alt: '오렌지 배경 앞 수트 차림의 금발 모델', left: '30%', top: '34%', height: 'clamp(280px, 37svh, 400px)' },
  ...
  { criterion: 'EXPRESSION', title: '편안한 표정과 움직임', description: '서로 가까워지는 순간의 시선과 긴장을 포착합니다.', type: 'image', src: '/assets/web-studio/gallery/sunlit-couple.png', alt: '햇빛 아래 서로 마주 보는 젊은 남녀', left: '42%', top: '35%', height: 'clamp(280px, 37svh, 400px)' },
  { criterion: 'LIGHT', title: '고르지 않은 빛', description: '거리의 역광이 머리카락과 옷의 윤곽을 따라 흐릅니다.', type: 'image', src: '/assets/web-studio/gallery/blue-cardigan-street.png', alt: '햇빛이 비치는 거리에서 파란 가디건을 입은 여성', left: '46%', top: '0%', height: 'clamp(340px, 45svh, 490px)' },
  { criterion: 'LIGHT', title: '고르지 않은 빛', description: '거울 사이로 스며든 낮은 햇빛을 그대로 사용합니다.', type: 'image', src: '/assets/web-studio/gallery/mirror-makeup-sunlight.png', alt: '저녁 햇빛 속 거울 앞에서 메이크업하는 인물', left: '51%', top: '36%', height: 'clamp(290px, 38svh, 420px)' },
  { criterion: 'TEXTURE', title: '살아 있는 질감', description: '유리의 반사와 오래된 나무, 거리의 층을 함께 담습니다.', type: 'image', src: '/assets/web-studio/gallery/perfumer-window-street.jpeg', alt: '거리에서 유리창 너머로 바라본 오래된 향수 공방', left: '53%', top: '34%', height: 'clamp(250px, 33svh, 360px)' },
  ...
  { criterion: 'LIGHT', title: '고르지 않은 빛', description: '강한 오후 햇빛이 만든 그림자까지 표정의 일부로 남깁니다.', type: 'image', src: '/assets/web-studio/gallery/sunlit-orange-selfie.png', alt: '강한 오후 햇빛 아래 웃는 금발 모델', left: '64%', top: '39%', height: 'clamp(260px, 34svh, 370px)' },
  { criterion: 'LIGHT', title: '고르지 않은 빛', description: '밤의 입자와 비눗방울에 흩어진 빛을 살립니다.', type: 'image', src: '/assets/web-studio/gallery/night-bubbles-fashion.png', alt: '밤거리 비눗방울 사이에 선 여성', left: '70%', top: '3%', height: 'clamp(360px, 48svh, 520px)' },
  { criterion: 'EXPRESSION', title: '편안한 표정과 움직임', description: '정돈된 초상 안에서도 시선과 어깨의 미세한 긴장을 남깁니다.', type: 'image', src: '/assets/web-studio/gallery/quiet-satin-portrait.png', alt: '새틴 의상을 입고 뒤를 돌아보는 인물 초상', left: '76%', top: '38%', height: 'clamp(260px, 35svh, 380px)' },
  ...
  { criterion: 'TEXTURE', title: '살아 있는 질감', description: '차가운 색 안에서도 젖은 머리와 피부의 결을 선명하게.', type: 'image', src: '/assets/web-studio/gallery/blue-scarf-beauty.png', alt: '푸른 스카프를 두른 금발 모델의 뷰티 초상', left: '87%', top: '36%', height: 'clamp(280px, 37svh, 400px)' },
  { criterion: 'FRAMING', title: '조금은 어색한 구도', description: '컵과 필기구가 시선을 가로막는 일상적인 카페 프레임.', type: 'image', src: '/assets/web-studio/gallery/cafe-study-candid.png', alt: '카페 테이블 너머로 촬영한 공부 중인 인물', left: '92%', top: '4%', height: 'clamp(300px, 40svh, 430px)' },
  { criterion: 'EXPRESSION', title: '편안한 표정과 움직임', description: '제품을 든 손과 표정을 하나의 캠페인 장면으로 연결합니다.', type: 'image', src: '/assets/web-studio/gallery/coral-lip-campaign.png', alt: '코랄 립 제품을 든 금발 모델의 캠페인 이미지', left: '97%', top: '35%', height: 'clamp(290px, 38svh, 410px)' },
] as const;
        ...
        <section className="statement-section reveal-section" id="statement" data-reveal-section>
          <div className="section-inner statement-inner">
            ...
            <p className="reveal-item" style={{ '--reveal-order': 1 } as CSSProperties}>
              고르지 않은 빛, 살아 있는 질감, 편안한 표정, 어색한 구도.
              <br />
              HEZZ STUDIO는 이 자연스러움의 기준을 연구합니다.
            </p>
          </div>
        </section>
